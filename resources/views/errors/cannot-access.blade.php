...
<a class="avatar" href="{{ admin_link('/') }}" title="If you liked this pen, don't forget to heart, share and follow ❤"><img src="{{ admin_link('anhkhoa.jpg') }}"/></a>
<script>
