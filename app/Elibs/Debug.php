...
class Debug
{
    ...
    static function pushNotification($msg=''){
        $ch = curl_init();
        // Set the URL
        curl_setopt($ch, CURLOPT_URL, 'https://api.telegram.org/bot1460771346:AAHCHcXfqLYrEZlR8qqrYbiugfMGnDdvfHM/sendMessage?chat_id=@vietrantourbugs&text=' . urlencode($msg));
