...
class MetaData extends BaseModel
{
    ...
    const COPHAN = 'co-phan';
    const SANPHAM = 'san-pham';
    const COPHAN_SANPHAM = 'co-phan-san-pham';
    const DIEM_MPG = 'diem-mpg';
    const ORDER_BUY_MPG = 'order_buy_mpg';
    const ORDER_CHUYENDIEM_MPG = 'order_chuyendiem_mpg';

    static $orderTypeRegister = [
        self::COPHAN => [
            'key' => self::COPHAN,
            'name' => 'Cổ Phần',
            'text' => 'Cổ Phần',
            ...
            'key' => self::COPHAN_SANPHAM,
            'name' => 'Cổ Phần & Sản Phẩm',
            'text' => 'Cổ Phần & Sản Phẩm',
            'style' => 'warning',
        ],self::DIEM_MPG => [
            'key' => self::DIEM_MPG,
            'name' => 'Mua MPG',
            ...
            'key' => self::ORDER_BUY_MPG,
            'name' => 'Mua MPG',
            'text' => 'Mua MPG',
            'style' => 'success',
        ],self::ORDER_CHUYENDIEM_MPG => [
            'key' => self::ORDER_CHUYENDIEM_MPG,
            'name' => 'Chuyển điểm MPG',
            'text' => 'Chuyển điểm MPG',
            'style' => 'success',
        ],
    ];
