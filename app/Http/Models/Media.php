...
class Media extends BaseModel
{
    ...
    static function buildImageLink($src, $no_image = '')
    {
        ...
        return config('filesystems.media_domain').config('filesystems.media_folder') . $src . '?ver=' . HtmlHelper::$clientVersion;
    ...
    static function getFileLink($link)
    {
        ...
        return config('filesystems.media_domain'). 'data/'.$url;
    }
